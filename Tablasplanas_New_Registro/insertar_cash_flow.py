...
def insertar_registros(json_list):
    ...
    for json_raw in json_list:
        registro = normalize_cash_flow(json_raw)
        if not registro:
            fallidos += 1
            continue
...
if __name__ == "__main__":
    json_list = [
        '{"symbol": "AAPL", "calendarYear": "2024", "operatingCashFlow": 10000000, "freeCashFlow": 7500000}',
        '{"symbol": "GOOG", "calendarYear": "2023", "operatingCashFlow": 15000000, "freeCashFlow": 11000000}',
    ]
    print("🧪 Insertando registros de prueba en cash_flow...")
