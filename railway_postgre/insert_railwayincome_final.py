...
# --- CONFIGURACIÓN ---
TABLA = 'income_statement_final'
LOTE = 1000  # Puedes modificarlo

COLUMNAS = [
    'ticker', 'anio', 'revenue', "costOfRevenue", "grossProfit", "operatingExpenses",
    "sellingGeneralAndAdministrativeExpenses", "depreciationAndAmortization", "otherExpenses",
    "researchAndDevelopmentExpenses", "operatingIncome", "totalOtherIncomeExpensesNet",
    "interestIncome", "interestExpense", "incomeBeforeTax", "netIncome", "ebitda",
    "weightedAverageShsOutDil", "eps", "date", "reportedCurrency", "grossProfitRatio",
    "generalAndAdministrativeExpenses", "sellingAndMarketingExpenses", "costAndExpenses",
    "ebitdaratio", "operatingIncomeRatio", "incomeBeforeTaxRatio", "incomeTaxExpense",
