...
TICKERS_FILE = "E:/@VALUECONOMICS/PROYECT DEL PROGRAMA/TEWEB/tickers_recientes_enterprise_values.txt"
TABLA_SQLITE = "enterprise_values"
TABLA_PG = "enterprise_values_plana"
...
def main():
    ...
    df = normalize_enterprise_values(registros)
